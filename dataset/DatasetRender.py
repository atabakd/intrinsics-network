...
class DatasetRender:
    ...
    def __init__(self, dataset_path, staging_path, write_path, create):
    ...
    def load(self, category, name='shape'):
        if category == 'random':
            category = self.__getSubdirectories(self.dataset_path)
    ...
    def __choose(self, category):
        ...
        print(os.path.join(self.dataset_path, selection, 'model.obj'))
